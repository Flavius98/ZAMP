...
public:
        ...
        std::string returnParameters()
        {
                ...
                char buffer[200];
                int len = sprintf(buffer, " Name=%s RGB=(%d,%d,%d) Scale=(%d,%f,%.0f) Shift=(%f,%f,%f) RotXYZ_deg=(%f,%f,%f) Trans_m=(%f,%f,%f)\n",
                this->_Name.c_str(), this->color[0], this->color[1], this->color[2],(int)this->_Scale[0],this->_Scale[1],this->_Scale[2],
